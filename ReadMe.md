...
<p>
  ...
  <img src="https://komarev.com/ghpvc/?username=AhmedRaza02912&label=Profile%20Views&color=0e75b6&style=for-the-badge" />
</p>
...
The application integrates motorsport APIs to provide race information, driver standings, constructor standings, race results, upcoming events and more.

**Tech:** `C#` `ASP.NET Core` `React` `REST APIs`
...
**Tech:** `Flutter` `Dart` `Flame Engine` `SQLite`
